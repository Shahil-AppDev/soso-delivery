...
3. If you need only the changed files for mobile apps in V8.4 check the User app and web changed files from V8.3 to V8.4 folder
otherwise please use User app and web folder.

Documentation: https://stackfood.app/documentation/